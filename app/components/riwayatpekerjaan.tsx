export default function RiwayatKerja() {
    return (
        ...
        <RowRiwayatKerja tahun="2020" instansi="Telkom" jabatan="Pegawai" />
        <RowRiwayatKerja tahun="2021" instansi="cv SANJAYA" jabatan="Tata Usaha" />
        <RowRiwayatKerja tahun="2022" instansi="PT Wisma mulya" jabatan="Data Analis" />
